...
def parse_args():
    ...
    parser.add_argument("--num_threads", type=int, default=1, help="Number of thread to run.")
    parser.add_argument("--save_dir", type=str, default="./image", help="Dir which images are saved. (default is ./image)")
    parser.add_argument("--url_dir", type=str, default="./", help="Dir which NUS-WIDE-urls file located. (default is ./)")
    parser.add_argument("--log_dir", type=str, default="./", help="Dir which log file is saved. (default is ./)")
